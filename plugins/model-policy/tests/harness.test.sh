...
check "no flag, COPILOT_CLI: Copilot shape" gpt-5.4-mini "$(payload copilot explore "" x | COPILOT_CLI=1 run | jq -r .modifiedArgs.model)"
...
check "Copilot loading the Claude hook: Copilot shape" gpt-5.4-mini \
